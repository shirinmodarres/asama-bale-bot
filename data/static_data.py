...
SALES_EXPERTS = {
    "expert_1": {
        ...
        "full_name": "Sales Expert 1",
    },
    "expert_2": {
        "telegram_id": 838414503,
        "full_name": "Sales Expert 2",
    },
}

STORES = {
    "1": {"code": "1", "name": "فتح المبین(شیراز)", "expert_key": "expert_1"},
    "2": {"code": "2", "name": "سنندج", "expert_key": "expert_1"},
    "3": {"code": "3", "name": "گرگان", "expert_key": "expert_1"},
    "4": {"code": "4", "name": "شاهین شهر", "expert_key": "expert_1"},
    "5": {"code": "5", "name": "اهواز", "expert_key": "expert_1"},
    "6": {"code": "6", "name": "بیرجند", "expert_key": "expert_1"},
    "7": {"code": "7", "name": "تبریز", "expert_key": "expert_1"},
    "8": {"code": "8", "name": "زنجان", "expert_key": "expert_1"},
    "9": {"code": "9", "name": "فلاحی", "expert_key": "expert_1"},
    "10": {"code": "10", "name": "رشت", "expert_key": "expert_1"},
    "11": {"code": "11", "name": "شهرکرد", "expert_key": "expert_1"},
    "12": {"code": "12", "name": "اراک", "expert_key": "expert_1"},
    "13": {"code": "13", "name": "یاسوج", "expert_key": "expert_1"},
    "14": {"code": "14", "name": "کرج", "expert_key": "expert_1"},
    "15": {"code": "15", "name": "اردبیل", "expert_key": "expert_1"},
    "16": {"code": "16", "name": "شهدای انقلاب", "expert_key": "expert_1"},
    "17": {"code": "17", "name": "فکوری", "expert_key": "expert_1"},
    "18": {"code": "18", "name": "امامی نسب", "expert_key": "expert_1"},
    "19": {"code": "19", "name": "فردیس", "expert_key": "expert_1"},
    "20": {"code": "20", "name": "لویزان", "expert_key": "expert_1"},
    "21": {"code": "21", "name": "شهید محلاتی", "expert_key": "expert_1"},
    "22": {"code": "22", "name": "مراغه", "expert_key": "expert_1"},
    "23": {"code": "23", "name": "رودهن", "expert_key": "expert_1"},
    "24": {"code": "24", "name": "رجایی", "expert_key": "expert_2"},
    "25": {"code": "25", "name": "ارومیه", "expert_key": "expert_2"},
    "26": {"code": "26", "name": "دزفول", "expert_key": "expert_2"},
    "27": {"code": "27", "name": "قصر فیروزه", "expert_key": "expert_2"},
    "28": {"code": "28", "name": "ایلام", "expert_key": "expert_2"},
    "29": {"code": "29", "name": "کرمانشاه مرکزی", "expert_key": "expert_2"},
    "30": {"code": "30", "name": "قزوین", "expert_key": "expert_2"},
    "31": {"code": "31", "name": "همدان", "expert_key": "expert_2"},
    "32": {"code": "32", "name": "اصفهان", "expert_key": "expert_2"},
    "33": {"code": "33", "name": "زاهدان", "expert_key": "expert_2"},
    "34": {"code": "34", "name": "یزد", "expert_key": "expert_2"},
    "35": {"code": "35", "name": "بجنورد", "expert_key": "expert_2"},
    "36": {"code": "36", "name": "ساری", "expert_key": "expert_2"},
    "37": {"code": "37", "name": "سمنان", "expert_key": "expert_2"},
    "38": {"code": "38", "name": "قم", "expert_key": "expert_2"},
    "39": {"code": "39", "name": "چمران", "expert_key": "expert_2"},
}
